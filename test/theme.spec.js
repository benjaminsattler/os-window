describe('themes', () => {
    ...
    describe('mac os theme', () => {
        ...
        describe('light theme', () => {
            ...
            describe('window title bar', () => {
                it('has correct height', () => {
                    const titleBar = mac_light.toDomElement().shadow.querySelector('.window-title-bar');
            ...
            describe('window content slot wrapper', () => {
                it('has correct spacing left', () => {
                    const slotWrapper = mac_light.toDomElement().shadow.querySelector('.window-content-slot-wrapper');
        ...
        describe('dark theme', () => {
            ...
            describe('window title bar', () => {
                it('has correct height', () => {
                    const titleBar = mac_dark.toDomElement().shadow.querySelector('.window-title-bar');
                    const height = window.getComputedStyle(titleBar).getPropertyValue('height');
                    chai.expect(height).to.equal('40px');
                });
            ...
            describe('window content slot wrapper', () => {
                it('has correct spacing left', () => {
                    const slotWrapper = mac_dark.toDomElement().shadow.querySelector('.window-content-slot-wrapper');
                    const paddingLeft = window.getComputedStyle(slotWrapper).getPropertyValue('padding-left');
                    chai.expect(paddingLeft).to.equal('16px');
                });
...
function getStyles(win, selector, pseudoelement) {
    return window.getComputedStyle(win.toDomElement().shadow.querySelector(selector), pseudoelement);
}
...
function assertStylesEqual(styles1, styles2) {
    ...
    for(let i = 0; i < styles1.length; i = i + 1) {
