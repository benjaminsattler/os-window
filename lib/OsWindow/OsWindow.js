...
<style>
    ...
    * {
    ...
    .window-wrapper {
        ...
        --win-7-window-border-color: rgba(161,187,215,.15);
        ...
        --win-7-window-title-bar-text-shadow: 1px 1px 15px rgba(255,255,255,.7);
    ...
    :host([os-theme="win-7"]) .window-wrapper {
        background-color: var(--win-7-window-border-color);
    }
